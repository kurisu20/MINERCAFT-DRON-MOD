...
package net.mcreator.drone.world.dimension;
...
import net.mcreator.drone.item.ModernworldItem;
import net.mcreator.drone.DroneModElements;
...
@DroneModElements.ModElement.Tag
public class ModernworldDimension extends DroneModElements.ModElement {
	@ObjectHolder("drone:modernworld_portal")
	public static final CustomPortalBlock portal = null;
	public ModernworldDimension(DroneModElements instance) {
		super(instance, 2);
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("drone:modernworld"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
	...
	public static final TicketType<BlockPos> CUSTOM_PORTAL = TicketType.create("modernworld_portal", Vector3i::compareTo, 300);
	public static class POIRegisterHandler {
		...
		public void registerPointOfInterest(RegistryEvent.Register<PointOfInterestType> event) {
			poi = new PointOfInterestType("modernworld_portal", Sets.newHashSet(ImmutableSet.copyOf(portal.getStateContainer().getValidStates())), 0,
					1).setRegistryName("modernworld_portal");
	...
	public void initElements() {
		...
		elements.items.add(() -> new ModernworldItem().setRegistryName("modernworld"));
	}
	public static class CustomPortalBlock extends NetherPortalBlock {
		public CustomPortalBlock() {
			...
			setRegistryName("modernworld_portal");
		}
			...
			if (!entity.isPassenger() && !entity.isBeingRidden() && entity.isNonBoss() && !entity.world.isRemote && true) {
				if (entity.func_242280_ah()) {
					entity.func_242279_ag();
						...
						new ResourceLocation("drone:modernworld"))) {
					entity.func_242279_ag();
					teleportToDimension(entity, pos, RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("drone:modernworld")));
				} else {
					entity.func_242279_ag();
	...
	public static class CustomPortalSize {
		private static final AbstractBlock.IPositionPredicate POSITION_PREDICATE = (state, blockReader, pos) -> {
			return state.getBlock() == Blocks.IRON_BLOCK.getDefaultState().getBlock();
		};
					...
					for (int k2 = 0; k2 < 2; ++k2) {
						for (int i3 = -1; i3 < 3; ++i3) {
							BlockState blockstate1 = i3 < 0
									? Blocks.IRON_BLOCK.getDefaultState().getBlock().getDefaultState()
									: Blocks.AIR.getDefaultState();
